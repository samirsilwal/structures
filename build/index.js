...
console.log(ss.unPile(1).toString);
console.log(ss.size);
console.log(ss.map(function (x) { return x + 12; }));
console.log(new ll_1.LinkedList().fromArray([1, 2, 3, 4, 5, 10, 89]).reverse());
var y = new stack_1.Stack().fromLinkedList(new ll_1.LinkedList().fromArray([1, 2, 3, 4]));
console.log(y);
